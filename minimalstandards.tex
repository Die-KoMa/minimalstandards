...
\fancyfoot[EL]{\scshape \footnotesize KoMa-Leitfaden}
...
%wichtig: entweder exlude ODER include muss für jeden Befehl angegeben werden!
\excludeversion{kcmt}
\excludeversion{stilltodo}
\excludeversion{kcmt62}
\excludeversion{kcmt6XX}
\includeversion{kcmt62}
\includeversion{kcmt6XX}
\includeversion{kcmt}
